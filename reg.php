...
xmlhttp.open('GET', 'admin/city.php?state='+x , true);
xmlhttp.send();
}
                                    ...
                                    if($b['loginname']==$mobileno){
                                        ...
                                        if($b['emailid']==$emailid){
                                            ...
                                            (`fullname`, `usertype`, `loginname`, `emailid`, `address`,`cityname`,
                                                `mobileno`, `pswrd`, `remarks`, `walletamount`, `loginid`, `logdate`, `statename`, `refrenceid`, `aadharpoint`, `cardrate`,`ispaid`,`status`,`fstatus`) 
                                            VALUES ('".$username."','".$usertype."','".$mobileno."','".$emailid."','".$address."','".$city."','".$mobileno."','".$password."','".$remark."','".$walletamount."', '".$_SESSION['userid']."',now(),'".$_SESSION['userid']."','".$refrenceid."','".$aadharpoint."','".$cardrate."',1,1,'FREE')";
                                            }
                                            else
                                            {
                                                $query = "INSERT INTO `tbluser`
                                        ...
                                        <div class="row col-md-12 col-sm-12 col-xs-12">
                                            <div class="col-md-3 col-sm-3 col-xs-6">
                                                ...
                                                <select class="form-control"  name="usertype" id="usertype"  required>
                                                   <option value="RETAILER">Select A Type</option>
                                   <option value="RETAILER"><font color="red">RETAILER </font>- (UNLIMITED POINT, LIFETIME FREE PRINT)</option>
                                   <option value="DISTRIBUTER">DISTRIBUTER -             (UNLIMITED POINT, UNLIMITED ID CREATE)</option>
                                   <option value="SUPER DISTRIBUTER">SUPER DISTRIBUTER - (UNLIMITED POINT, UNLIMITED ID CREATE)</option>
                                   <option value="CHANNEL PARTNER">CHANNEL PARTNER -     (UNLIMITED POINT, UNLIMITED ID CREATE)</option>
