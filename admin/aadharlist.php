							...
							<div class="row dgnform">
								...
								<table class="table-striped table-hover" width="100%" cellpadding="10" cellspacing="0" style="font-size:12px;font-weight:bold;" >
									...
									if ($_SESSION['userid']==1){
										...
										$sql="SELECT `aadharautoid`,`aadharno`, `aadharname`, `street`, `panchayat`, `vtcandpost`, `dist`, `statename`, `pincode`, `srno`, `createdatetime` FROM `aadharauto` WHERE userid='".$_SESSION['userid']."'";
									}
									...
									<tr id="a">
										...
										<td align="center" valign="middle"> <a  style="margin-top:2px;margin-bottom:2px;padding-top:2px;padding-bottom:2px;"  class="btn btn-success" href="aadharsso/aadhar.php?searchid=<?php echo $b['aadharautoid']?>" target="_blank"> Print </a> </td>
