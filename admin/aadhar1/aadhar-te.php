        ...
        <div class="pdf">
            <div class="left">
                <div class="one">
                    ...
                    <p> నమోదు సంఖ్య / Enrolment No: <?php echo $b['srno']?> </p>
                    <div class="rtt">
...
?>
                ...
                <div class="two">
                     <h4>మీ  <span>ఆధార్ </span> సంఖ్య / Your <span>Aadhaar</span> No. :</h4>
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <h2>నా  <span>ఆధార్ </span>, నా గుర్తింపు </h2>
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        <img src="images/tel2.jpg" class="img2">
                        <div class="a_lft">
       <?php if ($b['filetype']=="SSO"){ ?>
        ...
        <?php } ?>
                    ...
                    <img src="images/Telgu.jpg" class="img7">
                </div>
            ...
            <div class="right">
                <div class="one">
                    ...
                    <div class="info">
                        <h4>సమాచారం</h4>
          <ul>
              <li style="font-size: 10px;"><span>ఆధార్‌</span> గుర్తింపుకు ధృవీకరణ, పౌరసత్వానికి కాదు.</li>
              <li style="font-size: 10px;">గుర్తింపుకు ధృవీకరణ ఆన్‌లైన్‌ అథెంటికేషన్‌ ద్వారా పొందవచ్చు.</li>
              <li style="font-size: 10px;">ఇది ఎలానిక్‌ పద్ధతిలో వ్రాయబడిన లేఖ.</li>
          </ul>
                        <h4>Information</h4>
                        <ul>
                    ...
                    <div class="info2">
                        <ul>
                             <li><span>ఆధార్‌</span> దేశమంతటా ఆమోదించబడుతుంది .</li>
              <li><span>ఆధార్‌</span>  భవిష్యత్తులో ప్రభుత్వ మరియు ప్రభుత్వేతర <br><span class="brk">సేవలు అందచేయడంలో సహాయ పడుతుంది. </span></li>
                ...
                <div class="adhr adhr2">
                    <img src="img/cut.png" class="cut">
                    <div class="three">
                        <img src="images/tel3.jpg" class="img2">
                        <div class="b_lft">
                            <ul>
