        ...
        <div class="pdf">
            <div class="left">
                <div class="one">
                    ...
                    <p> பதிவு எண் / Enrolment No: <?php echo $b['srno']?> </p>
                    <div class="rtt">
...
?>
                ...
                <div class="two">
                    <h4>உங்கள்  <span>ஆதார் </span> எண் / Your <span>Aadhaar</span> No. :</h4>
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                   <h2>எனது   <span>ஆகார் </span>,  எனது அடையாளம் </h2>
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        <img src="images/tam2.jpg" class="img2">
                        <div class="a_lft">
        ...
        <?php } ?>
                    ...
                    <img src="images/Tamil.jpg" class="img7">
                </div>
            ...
            <div class="right">
                <div class="one">
                    ...
                    <div class="info">
                         <h4>தகவல்‌</h4>
          <ul>
              <li><span>ஆதார்‌ </span> அடையாளத்திற்கான சான்று,  <br><span class="brk">குடியுரிமைக்கு அல்ல.</span></li>
              <li>அடையாள சான்றை ஆன்லைன்‌ ஆதன்டிகேஷன்‌ <br><span class="brk"> மூலமாகட்‌ பெறவும்‌.</span></li>
              <li>இது எலக்ட்ரானிக்‌ செயல்முறை மூலம்‌ <br><span class="brk"> தயாரிக்கப்பட்ட கடிதமாகும்‌.</span></li>
          </ul>
                        <h4>Information</h4>
                        <ul>
                    ...
                    <div class="info2">
                        <ul>
                            <li><span>ஆதார்‌</span>  நாடூ முழுவதிலும்‌ செல்லுபடியாகும்‌.</li>
              <li>வருங்காலத்தில்‌ அரசு மற்றும்‌ அரசு சாரா <br><span class="brk"> சேவைகளை பயன்படுத்திக்‌ கொள்ள <span>ஆதார்‌</span> </span> <br><span class="brk"> உதவிகரமாக இருக்கும்‌.</span></li>
                ...
                <div class="adhr adhr2">
                    <img src="img/cut.png" class="cut">
                    <div class="three">
                        <img src="images/tam3.jpg" class="img2">
                        <div class="b_lft">
                            <ul>
                                <li><span>முகவரி:</span></li>
