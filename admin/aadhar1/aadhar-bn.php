        ...
        <div class="pdf">
            <div class="left">
                <div class="one">
                    ...
                    <p> নথিভুক্তি নম্বর / Enrolment No: <?php echo $b['srno']?> </p>
                    <div class="rtt">
...
?>
                ...
                <div class="two">
                      <h4>আপনার    <span>আধার   </span> সংখ্যা   / Your <span>Aadhaar</span> No. :</h4>
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <h2>আমার   <span>আধার,  </span> আমার পরিচয়</h2>
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        <img src="images/ban2.jpg" class="img2">
                        <div class="a_lft">
        ...
        <?php } ?>
                        ...
                        <div class="a_rgt">
                            <ul>
                                <li><?php echo $b['localname']?></li>
                                <li><?php echo $b['aadharname']?></li>
                                <li><?php /*echo $b['dobinlocal']*/echo 'জন্মতারিখ / '.'DOB : '?><?php echo $b['dob']?></li>
                    ...
                    <img src="images/Bengali.jpeg" class="img7">
                </div>
            ...
            <div class="right">
                <div class="one">
                    ...
                    <div class="info">
                         <h4>তথ্য</h4>
              <ul>
                  <li><span>আধার</span> পরিচয়ের প্রমাণ, নাগরিকত্বের প্রমাণ নয়</li>
                  <li>পরিচয়ের প্রমাণ অনলাইন অথেন্টিকেশন দ্বারা লাভ করুন</li>
                  <li>এটা এক ইলেক্্নিক প্রক্রিয়ায় তৈরী পত্র</li>
              </ul>
                        <h4>Information</h4>
                        <ul>
                    ...
                    <div class="info2">
                        <ul>
                             <li><span>আধার </span> সারা দেশে মান্য।</li>
                  <li><span>আধার </span>  ভবিষ্যতে সরকারী ও বেসরকারী পরিষেবা <br><span class="brk"> প্রাপ্তির সহায়ক হবে।</span></li>
                ...
                <div class="adhr adhr2">
                    <img src="img/cut.png" class="cut">
                    <div class="three">
                        <img src="images/ban3.jpg" class="img2">
                        <div class="b_lft">
                            <ul>
