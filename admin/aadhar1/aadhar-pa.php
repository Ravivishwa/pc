...
<html lang="pa">
    ...
    <body>
        <div class="pdf">
            <div class="left">
                <div class="one">
                    <img src="images/pun1.jpg">
                    <p> ਨਾਮ ਨੰਬਰ / Enrolment No: <?php echo $b['srno']?> </p>
                    <div class="rtt">
...
?>
                ...
                <div class="two">
                    <h4>ਤੁਹਾਡਾ <span>ਆਦਰ</span> ਨੰਬਰ / Your <span>Aadhaar</span> No. :</h4>
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <h2>ਮੇਰੇ <span>ਆਦਰ</span>, ਮੇਰੀ ਪਛਾਣ</h2>
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        <img src="images/pun2.jpg" class="img2">
                        <div class="a_lft">
        ...
        <?php } ?>
                    ...
                    <img src="images/Punjabi.jpg" class="img7">
                </div>
            ...
            <div class="right">
                <div class="one">
                    ...
                    <div class="info">
                        ...
                        <ul>
                            ...
                            <li><span>ਅਧਾਰ </span> ਪਛਾਣ ਦਾ ਮਾਨਤਾ, ਅਧਾਰ  ਨਾਗਰਿਕਤਾ ਨਹੀਂ.।</li>
                            <li>ਪਛਾਣ ਦਾ ਸਰਟੀਫਿਕੇਟ ਆਨਲਾਈਨ ਪ੍ਰਾਪਤ ਕਰੋ |</li>
                            <li>ਇਹ ਇਕ ਇਲੈਕਟ੍ਰਾਨਿਕ ਪ੍ਰਕਿਰਿਆ ਦੁਆਰਾ ਬਣਾਈ ਗਈ ਚਿੱਠੀ ਹੈ |</li>
                        </ul>
                        <h4>Information</h4>
                        <ul>
                    ...
                    <div class="info2">
                        <ul>
                            <li><span>ਅਧਾਰ</span> ਦੇਸ਼ ਭਰ ਵਿੱਚ ਵਿਚਾਰਿਆ ਜਾਂਦਾ ਹੈ |</li>
                            <li><span>ਅਧਾਰ</span> ਅਧਾਰ ਅਗਾਮੀ ਅਤੇ ਗ਼ੈਰ-ਸਰਕਾਰੀ ਸੇਵਾਵਾਂ  <br><span class="brk"> ਕਾਬਜ਼ ਲਾਭ ਵਿੱਚ ਲਾਭਦਾਇਕ ਹੋਵੇਗਾ ।</span></li>
                ...
                <div class="adhr adhr2">
                    <img src="img/cut.png" class="cut">
                    <div class="three">
                        <img src="images/pun3.jpg" class="img2">
                        <div class="b_lft">
                            <ul>
                                <li><span>ਪਤਾ:</span></li>
