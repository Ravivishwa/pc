...
<html lang="gu">
    ...
    <body>
        <div class="pdf">
            <div class="left">
                <div class="one">
                    <img src="images/guj1.jpg">
                    <p> નોંધણી નંબર / Enrolment No: <?php echo $b['srno']?> </p>
                    <div class="rtt">
...
?>
                ...
                <div class="two">
                    <h4>તમારા <span>આદર</span> નંબર / Your <span>Aadhaar</span> No. :</h4>
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <h2>મારા <span>આધાર</span>, મારી ઓળખ</h2>
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        <img src="images/guj2.jpg" class="img2">
                        <div class="a_lft">
        ...
        <?php } ?>
                    ...
                    <img src="images/Gujrati.jpg" class="img7">
                </div>
            ...
            <div class="right">
                <div class="one">
                    ...
                    <div class="info">
                        <h4>સૂચન</h4>
                        <ul>
                            <li><span>આધાર</span>  ઓળખાણનું પ્રમાણ છે, નાગરિકતાનું નહિં.</li>
              <li>ઓળખાણનું પ્રમાણ ઓનલાઈન ઓથેન્ટિકેશન દ્વારા પ્રાપ્ત કરો.</li>
              <li>આ ઈલેક્ટ્રોનિક પ્રક્રિયા દ્રારા બનાવેલા દસ્તાવેજ છે.</li>
                        </ul>
                        <h4>Information</h4>
                        <ul>
                    ...
                    <div class="info2">
                        <ul>
                             <li><span>આધાર</span> દેશભરમાં માન્ય છે.</li>
              <li><span>આધાર</span>  ભવિષ્યમાં સરકારી અને બિન-સરકારી<br><span class="brk"> સેવાઓનો લાભ મેળવવામાં ઉપયોગી યશે .</span></li>
                ...
                <div class="adhr adhr2">
                    <img src="img/cut.png" class="cut">
                    <div class="three">
                        <img src="images/guj3.jpg" class="img2">
                        <div class="b_lft">
                            <ul>
                                <li><span>ખબર:</span></li>
