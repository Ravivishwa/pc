                            ...
                            <form method="post" name="form" autocomplete="off"  enctype="multipart/form-data"  style="width:100%" id="my-form" class="forms">
										...
										<div class="row" >
										   ...
										   <div class="form-group">
										    <input class="form-control valid" id="aadhar_number" maxlength="12" placeholder="Enter Customer's Aadhaar Number (कस्टमर का आधार नंबर डाले)" name="EnterAadhaarNumber" type="text" autocomplete="off">
