            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="page-header">
                        ...
                        <h1>Voter Card List (New Application)</h1>
                        </div>
                    </div>
                </div>
                <!-- /# row -->
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table-striped table-hover" width="100%" cellpadding="10" cellspacing="0" style="font-size:12px;" >
                                <tr style="background:#ff9b00;">
                                    ...
                                    <?php } ?>
                                    <td align="left" valign="left">   Assembly     </td>
                                    ...
                                    <td align="left" valign="left">   Documents  </td>
                                ...
                                $sql = "SELECT a.`cardnumber`,a.`sid`,a.`assembly`, a.`name`, a.`fathername`, a.`address`, a.`status`, a.`gender`, a.`dob`,"
                                    ...
                                    . " where $where and (a.type = 'N') order by a.sid desc, a.status desc";
    ...
    $date = date_create($b['createdatetime']); ?>
                                    <tr id="a">
                                        ...
                                        <td align="left" valign="left">
                                            <a target="_blank" href="<?php echo $upload_dir . $b['imagepathoriginal']?>" >PHOTO</a> / 
                                            <a target="_blank" href="<?php echo $upload_dir . $b['idproof']?>" >ID Proof</a><br>
                                            <a target="_blank" href="<?php echo $upload_dir . $b['addressproof']?>" >Address Proof</a>
                                        </td>
...
<a class="btn btn-success btn-sm" onclick="return confirm('Are you sure for this action?');" href="actions.php?page=votermapply&status=done&action=update&sid=<?php echo $b['sid'];?>">Done</a>
<a class="btn btn-warning btn-sm" onclick="return confirm('Are you sure for this action?');" href="actions.php?page=votermapply&status=cancel&action=update&sid=<?php echo $b['sid'];?>&to=<?php echo $b['userid'];?>">Cancel</a>
                        </td>
        <?php } ?>
                                            <td align="center" valign="middle">
...
<a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure for this action?');" href="actions.php?page=votermapply&status=&action=delete&sid=<?php echo $b['sid'];?>">Delete</a>
                                            </td>
    <?php } ?>
                                    </tr>
<?php } ?>
