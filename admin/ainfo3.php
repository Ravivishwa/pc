...
<?php
 if(isset($_SESSION['aadhar_old_data']))
 {
    $fetch_data = $_SESSION['aadhar_old_data'];
                 ...
                 <?php
                                    ...
                                    //   var_dump($aadhar_data);
                                       ...
                                       // exit;                                        
                                        ...
                                        $aadharno= $fetch_data['aadharno'];
                                        $txtnm = $fetch_data['aadharname'];
                                        $txtfnm= $fetch_data['fathername'];
                                        $txtdob = $fetch_data['dob'];
                                        
                                         $txtgender= $fetch_data['gender'];
                                        
                                        $txtbuld= $fetch_data['houseno'];//"";
                                        $txtgali= $fetch_data['street'];
                                        $txtlocality= '';
                                        $txtpost="";
                                        $txttaluka= $fetch_data['vtcandpost'];
                                        $txtdistrict= $fetch_data['dist'];
                                        $txtstate=  $fetch_data['statename'];
                                        $txtpincode= $fetch_data['pincode'];
                                        $img= $fetch_data['imgcode'];

                                        $rel = "S/O";
    
    
    $txtadd = $fetch_data['fulladdress'];
                                    } 
...
?>
    ...
    else
    {
        ...
        $st = '';
          ...
          $taluka = '';
            /// insert value
          codepitch_delete_data('aadharautodbt',array('aadharno' =>trim($aadharno)));
            ...
            if($result)
            {
                unset($_SESSION['aadhar_old_data']);
            }
